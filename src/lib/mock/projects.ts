...
const cosmicScenes: MockScene[] = [
  {
    ...
    thumbnailUrl: svgThumb('%237C3AED', '%2322D3EE'),
    duration: 24, status: 'completed',
    takes: makeTakes('cosmic-1', [['%237C3AED', '%2322D3EE'], ['%236D28D9', '%230EA5E9'], ['%238B5CF6', '%2306B6D4']]),
  },
  {
    ...
    thumbnailUrl: svgThumb('%23A855F7', '%23F59E0B'),
    duration: 20, status: 'completed',
    takes: makeTakes('cosmic-2', [['%23A855F7', '%23F59E0B'], ['%239333EA', '%23D97706']]),
  },
  {
    ...
    thumbnailUrl: svgThumb('%2306B6D4', '%237C3AED'),
    duration: 18, status: 'completed',
    takes: makeTakes('cosmic-3', [['%2306B6D4', '%237C3AED'], ['%230891B2', '%236D28D9']]),
  },
  {
    ...
    thumbnailUrl: svgThumb('%23EC4899', '%237C3AED'),
    duration: 26, status: 'completed',
    takes: makeTakes('cosmic-4', [['%23EC4899', '%237C3AED'], ['%23DB2777', '%236D28D9']]),
  },
  {
    ...
    thumbnailUrl: svgThumb('%23F59E0B', '%23EF4444'),
    duration: 22, status: 'completed',
    takes: makeTakes('cosmic-5', [['%23F59E0B', '%23EF4444'], ['%23D97706', '%23DC2626']]),
  },
  {
    ...
    thumbnailUrl: svgThumb('%2322D3EE', '%23A855F7'),
    duration: 20, status: 'completed',
    takes: makeTakes('cosmic-6', [['%2322D3EE', '%23A855F7'], ['%2306B6D4', '%239333EA']]),
  },
  {
    ...
    thumbnailUrl: svgThumb('%23F97316', '%23A855F7'),
    duration: 16, status: 'completed',
    takes: makeTakes('cosmic-7', [['%23F97316', '%23A855F7'], ['%23EA580C', '%239333EA']]),
  },
  {
    ...
    thumbnailUrl: svgThumb('%237C3AED', '%23EC4899'),
    duration: 26, status: 'completed',
    takes: makeTakes('cosmic-8', [['%237C3AED', '%23EC4899'], ['%236D28D9', '%23DB2777'], ['%238B5CF6', '%23F472B6']]),
  },
]
