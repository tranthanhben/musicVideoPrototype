...
export const RENDER_MODES = [
  { id: 'realistic' as const, label: 'Realistic', description: 'Real people & live-action scenes', shortDesc: 'Live-action', gradientFrom: '#1E1B4B', gradientTo: '#7C3AED', imageUrl: '/assets/styles/realistic.jpg' },
  { id: '3d' as const, label: '3D Animation', description: 'Pixar/Blender-style 3D renders', shortDesc: 'Pixar / Blender', gradientFrom: '#06B6D4', gradientTo: '#22D3EE', imageUrl: '/assets/styles/3d.jpg' },
  { id: '2d' as const, label: '2D Animation', description: 'Flat art & cel-style animation', shortDesc: 'Cel / Flat art', gradientFrom: '#F59E0B', gradientTo: '#F97316', imageUrl: '/assets/styles/2d.jpg' },
  { id: 'anime' as const, label: 'Anime', description: 'Japanese animation aesthetic', shortDesc: 'Japanese style', gradientFrom: '#EC4899', gradientTo: '#A855F7', imageUrl: '/assets/styles/anime.jpg' },
]
