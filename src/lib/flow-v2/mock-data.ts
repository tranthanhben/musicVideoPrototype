...
export const MOCK_STORYLINE_TEXT = `Two strangers meet at a seaside café at golden hour. Their bond deepens — walking the shore, dancing under string lights, watching storms from a lighthouse. Reality melts into dreamscapes: underwater ballrooms, floating lanterns, wildflowers swaying to the beat. Their first kiss dissolves everything into light, then back to the café where it began.`
...
export const MOCK_CONCEPTS: VisualConcept[] = [
  {
    ...
    details: {
      ...
      lightingStyle: 'Warm golden hour light with soft lens flares. Backlit silhouettes during sunset scenes. Candlelit interiors with gentle amber glow. Film-like halation around bright areas creating a nostalgic, dreamlike quality.',
  ...
  },
  {
    ...
    details: {
      ...
      lightingStyle: 'Saturated neon washes of violet and pink. Hard directional light creating dramatic shadows. Strobing during high-energy beats. Practical LED panels and UV reactive elements throughout scenes.',
  ...
  },
  {
    ...
    details: {
      ...
      lightingStyle: 'Diffused overcast light with occasional sun breaks. Dappled light through tree canopies. Misty morning atmospherics. Firefly-like particle effects during twilight scenes creating a fairy-tale ambience.',
