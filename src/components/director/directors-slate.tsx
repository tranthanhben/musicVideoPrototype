...
export function DirectorsSlate({
  ...
  const badgeClass = cn(
    ...
    STATUS_COLORS[status] ?? 'bg-stone-600 text-white'
  )

  return (
    <div className="w-full rounded-lg overflow-hidden border border-stone-700 shadow-2xl">
      ...
      {/* Slate body */}
      <div className="bg-stone-900 px-5 py-4 border-t-2 border-stone-700">
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1 min-w-0">
            ...
            <h1
              className="text-2xl font-bold text-stone-50 truncate"
        ...
        <div className="mt-3 flex items-center gap-6 text-sm text-stone-400">
          <span>
            <span className="text-stone-200 font-semibold">{sceneCount}</span> scenes
          </span>
          <span>
