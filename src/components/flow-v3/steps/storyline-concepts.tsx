...
import { makeSvgThumb } from '@/lib/flow-v3/mock-data'
import type { VisualConcept, StorylineVersion, ConceptDetails, ColorSwatch } from '@/lib/flow-v3/types'
...
export function StorylineConceptsSection({ selectedConceptId, onConceptSelect, onContinue, onConceptsReady, hideInlineDetails, onStateChange, durationRatio = 1 }: StorylineConceptsSectionProps) {
  ...
  useEffect(() => {
    import('@/lib/flow-v3/mock-data').then((mod) => {
      setMockData({
