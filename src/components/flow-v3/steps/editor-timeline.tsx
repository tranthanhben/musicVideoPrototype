...
export function EditorTimeline({
  ...
  return (
    <div className="flex flex-col bg-zinc-950 border-t border-white/8">
      ...
      {/* Time ruler */}
      <div className="relative h-5 border-b border-white/5 bg-zinc-900/50" onClick={handleTimelineClick}>
        {markers.map((t) => (
          <div
            key={t}
