  ...
  return (
    <div className="space-y-0.5">
      ...
      <input
        ...
        className="w-full text-[11px] text-foreground glass-input rounded-md px-2.5 py-1.5 leading-relaxed focus:outline-none transition-colors"
      />
    </div>
  )
}
...
export function StoryboardProperties({ scene, sceneIndex, timestamp, onClose, onUpdate }: StoryboardPropertiesProps) {
  ...
  return (
    <div className="flex flex-col h-full glass-surface border-l border-white/[0.08] overflow-hidden">
      {/* Header */}
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-2.5">
        ...
        <div className="space-y-0.5">
          ...
          <p className="text-[11px] text-foreground glass-input rounded-md px-2.5 py-1.5 leading-relaxed">{scene.duration}s</p>
        </div>

        {/* Prompt */}
        <div className="space-y-0.5">
          <p className="text-[9px] uppercase tracking-wide text-muted-foreground font-semibold">Full Prompt</p>
          <p className="text-[10px] text-muted-foreground glass-input rounded-md px-2.5 py-2 leading-relaxed font-mono">
            {scene.prompt}
          </p>
        </div>
        ...
        {scene.takes.length === 0 && (
          <div className="rounded-md glass-surface px-2.5 py-2 text-center">
