...
import type { VisualConcept, StorylineVersion, ConceptDetails, ColorSwatch } from '@/lib/flow-v5/types'
  ...
  return (
    <div className="space-y-2.5">
      ...
      <div className="rounded-xl bg-gradient-to-br from-primary/30 via-primary/10 to-transparent p-[1px]">
        <div className="rounded-[11px] glass-surface p-4 relative group">
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="px-3 py-2.5 flex items-center gap-1.5 glass-surface">
...
export function ConceptDetailsPanel({ concept, editedDetails, onEditDetails }: ConceptDetailsPanelProps) {
  ...
  return (
    ...
    >
      <div className="rounded-2xl glass-surface p-3 space-y-3 mt-2">
...
export function StorylineConceptsSection({ selectedConceptId, onConceptSelect, onContinue, onConceptsReady, hideInlineDetails, hideContinueButton, onStateChange, durationRatio = 1 }: StorylineConceptsSectionProps) {
  ...
  useEffect(() => {
    import('@/lib/flow-v5/mock-data').then((mod) => {
      setMockData({
