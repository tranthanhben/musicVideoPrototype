...
import type { Storyline } from '@/lib/flow-v5/types'
  ...
  return (
    ...
    >
      <motion.button
        ...
        onClick={onSelect}
        className={cn(
          'relative w-full rounded-2xl border p-0 text-left cursor-pointer overflow-hidden',
          isSelected ? 'border-primary shadow-lg shadow-primary/20' : 'border-white/[0.08] hover:border-white/[0.15]',
        )}
      >
        {/* Gradient header */}
