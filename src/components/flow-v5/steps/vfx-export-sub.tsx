          ...
          {VFX_PRESETS.map((vfx) => (
            <button
              ...
              className={cn(
                ...
                selectedVfx === vfx.id ? 'border-primary bg-primary/5' : 'border-white/[0.08] glass-surface hover:border-white/[0.15]',
              )}
            >
...
export function ExportPlatformCard({ fmt, exported }: ExportPlatformCardProps) {
  return (
    <motion.div
      ...
      className={cn(
        'flex flex-col items-center gap-1.5 rounded-2xl glass-surface p-3 transition-colors',
