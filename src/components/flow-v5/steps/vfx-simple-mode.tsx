...
import { VFX_PRESETS, TRANSITION_TYPES } from '@/lib/flow-v5/mock-data'
                ...
                <button
                  ...
                  className={cn(
                    ...
                    selectedVfx === vfx.id
                      ...
                      : 'border-white/[0.08] glass-surface text-muted-foreground hover:border-white/[0.15] hover:text-foreground',
                  )}
                >
                ...
                <button
                  ...
                  className={cn(
                    ...
                    selectedTransition === t.id
                      ...
                      : 'glass-surface border-white/[0.08] text-muted-foreground hover:text-foreground',
                  )}
                >
                  {t.label}
                </button>
            ...
            <motion.button
              ...
              className={cn(
                ...
                exported
                  ...
                  : rendering
                    ? 'bg-muted border-white/[0.08] text-muted-foreground cursor-not-allowed'
                    : 'glass-surface border-white/[0.08] text-foreground hover:bg-primary hover:border-primary hover:text-primary-foreground',
              )}
            >
              {exported ? (
