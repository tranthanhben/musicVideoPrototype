  ...
  return (
    <div className="shrink-0">
      ...
      <div className="flex items-center py-2">
        {/* Scene label — aligned with play button (w-24) */}
        <div className="w-24 shrink-0 flex items-center justify-center">
          <span className="text-[11px] font-mono font-semibold text-primary bg-primary/10 rounded-md px-2 py-1">
            S{activeSceneIndex + 1}
          </span>
        </div>

        {/* Tool buttons — aligned with waveform */}
