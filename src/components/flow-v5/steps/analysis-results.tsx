  ...
  return (
    <div ref={scrollContainerRef} className="flex h-full justify-center overflow-y-auto p-6">
      ...
      >
        ...
        <motion.div
          className="rounded-2xl glass-surface p-4 space-y-3"
        ...
        >
          ...
          <div className="flex items-center gap-2 flex-wrap">
            {metrics.map((m, i) => (
              <motion.span
                key={m.label}
                className="inline-flex items-center gap-1 rounded-full border border-white/[0.08] glass-surface px-2 py-0.5"
