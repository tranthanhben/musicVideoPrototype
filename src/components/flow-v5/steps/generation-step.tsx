                    ...
                    >
                      <div
                        className={cn(
                          ...
                          isEditing ? 'border-primary' : isRendering ? 'border-blue-500/50' : 'border-white/[0.08]',
                        )}
                      >
                        ...
                        {isEditing && (
                          <div className="p-2 space-y-1.5 glass-surface">
                            <input
                              ...
                              className="w-full rounded glass-input px-1.5 py-1 text-[10px] text-foreground focus:outline-none"
                              placeholder="Subject"
                            />
                            <input
                              value={editAction}
                            ...
                            <div className="flex gap-1">
                              <button onClick={saveEdit} className="flex-1 flex items-center justify-center gap-1 rounded glass-button py-1 text-[9px] font-semibold text-primary-foreground cursor-pointer">
                                <Check className="h-2.5 w-2.5" /> Save
                              </button>
                              <button onClick={() => setEditingId(null)} className="flex-1 flex items-center justify-center gap-1 rounded border border-white/[0.08] py-1 text-[9px] font-medium text-muted-foreground cursor-pointer">
