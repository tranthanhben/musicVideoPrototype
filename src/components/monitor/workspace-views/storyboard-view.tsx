          ...
          {project.scenes.map((scene, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className={cn(
                  'aspect-video rounded-xl overflow-hidden bg-muted relative transition-transform duration-200',
                  ...
                  {segInfo && (
                    <div
                      className="absolute top-1.5 left-1.5 z-10 rounded-md px-1.5 py-0.5"
